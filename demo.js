...
var models = {
	...
	monkey: {
		obj:"models/tenryu.obj",
		mtl:"models/tenryu.mtl",
	}
};
...
function init(){
	...
	scene.add(mesh);
	const texture_Floor = new THREE.TextureLoader().load( 'textures/grass.jpg' );
	meshFloor = new THREE.Mesh(
		new THREE.PlaneGeometry(40,40, 20,20),
		new THREE.MeshPhongMaterial({map:texture_Floor , wireframe:USE_WIREFRAME})
	);
...
function onResourcesLoaded(){
	...
	//monkey
	meshes["monkey"] = models.monkey.mesh.clone();
	meshes["monkey"].position.set(10,0,8);
	meshes["monkey"].scale.set(5,5,5);
	scene.add(meshes["monkey"]);
}
